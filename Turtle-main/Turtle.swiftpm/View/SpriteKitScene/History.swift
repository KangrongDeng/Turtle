...
struct History {
    ...
    @MainActor static func createHistoryPanel(
        sceneSize: CGSize,
        entries: [String]
    ) -> (
        container: SKNode,
        ...
        panel.fillColor = SKColor.white//.withAlphaComponent(0.8)
        ...
        for text in entries {
            ...
            bubble.fillColor = SKColor(cgColor: CGColor(red: 0.9, green: 0.9, blue: 0.9, alpha: 1.0))//SKColor.white.withAlphaComponent(0.85)
